...
public class OpenhubApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(OpenhubApp.class);

    private final Environment env;

    public OpenhubApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OpenhubApp.class);
